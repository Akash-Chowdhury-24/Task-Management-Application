...
//       // Ensure the item has a valid status and push to the corresponding array
...
//             draggable={item.status !== "done" ? true : false}
//           >
//             <h3 className={item.status === "done" ? "status-scrum-board-done-style" : null}>{item.title}</h3>
